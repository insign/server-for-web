...
step_initial() {
  ...
  install zsh git curl wget zip unzip expect fail2ban xclip whois awscli httpie mc p7zip-full htop neofetch python-pip ruby ruby-dev ruby-colorize fd-find fzf
